...
export async function generateMetadata({
  ...
  for (const locale of SUPPORTED_LOCALES) {
    languages[locale] = `${BASE_URL}/${locale}/privacy`;
  }
  languages['x-default'] = `${BASE_URL}/${DEFAULT_LOCALE}/privacy`;
  ...
  return (
    <main className="min-h-screen bg-[#152E4A] text-[#E8DFD0] px-6 py-24">
      <div className="container mx-auto max-w-3xl">
        <h1 className="text-3xl md:text-5xl font-light mb-8">{dict.privacy.title}</h1>
